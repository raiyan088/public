...
module.exports = class {
    ...
    constructor (browser, temp, data) {
        ...
        this.colab1 = this.decode('MVg5ZmdQVWVpXzYwbDBCTlk3TktMaWhCNUlTeTNfSzct')
        this.colab2 = this.decode('MXpUNUVzTmZBVkliS1J6TTVjUXNiekc2XzdsM0FYaUV5')
        this.colab3 = this.decode('MUVJWXQ1WTdDZ09LSWE1czRzYXZhRlVEcVZJN2RiRUw2')
        this.colab4 = this.decode('MUQybTh0Wk9aUU93UzhtWHgzWFhlVlc4Tmo1YnN4eHNU')
        this.colab5 = this.decode('MTZBV3RGeFZRVkxzQ01tdnE3QXZwQzkxdkh2ZHlySF9o')
