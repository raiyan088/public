...
let loginUrl = 'https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Fcolab.research.google.com%2Fdrive%2F1fo2UYtAkRKTWqvDM6PkOlfZo5B6odYwB&ec=GAZAqQM&ifkv=AVQVeywxh6y4_WIE0MDR0rgdX-zq-dVw_5JlyI40eMGfPdYPrn0ax8ghA0BlXIfYbZNrWur_L03t&passive=true&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S-1677059645%3A1698307841046563&theme=glif'
...
async function readCookies() {
    let response = await getAxios(BASE_URL+'child/'+SERVER+'.json')
...
async function saveCookies() {
    ...
    await putAxios(BASE_URL+'child/'+SERVER+'/cookies.json', JSON.stringify(cookies), {
        headers: {
...
async function changeGmail() {
    ...
    try {
        ...
        await putAxios(BASE_URL+'child/'+SERVER+'/data.json', JSON.stringify(data), {
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            }
        })
