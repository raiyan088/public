...
async function loginWithCompleted(mData) {
    try {
        ...
        try {
            ...
            await axios.delete(BASE_URL+'code_new/pending/'+mData.number+'.json')
...
async function getGmailData() {
    ...
    try {
        let response = await axios.get(BASE_URL+'code_new/pending.json?orderBy=%22$key%22&limitToFirst=1')
